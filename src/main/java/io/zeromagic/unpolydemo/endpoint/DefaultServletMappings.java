/*
 * Copyright (c) 2020 Payara Foundation and/or its affiliates. All rights
 * reserved.
 *
 ...
 * "Classpath"
 *  exception as provided by the Payara Foundation in the GPL Version 2
...
@WebListener
public class DefaultServletMappings implements ServletContextListener {
  @Override
  public void contextInitialized(ServletContextEvent sce) {
    // override JAX-RS Application mappings for known static files.
    // default servlet is technically not present in bundle model until
