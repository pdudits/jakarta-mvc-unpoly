...
public record FormField(String value, String message, Boolean valid) {
  ...
  public static <T> T parse(String value, Consumer<FormField> fieldSetter,
  ...
  public static <T> Function<String, T> require(String requiredMessage,
      Function<String, T> parser) {
    return value -> {
  ...
  public static <T> Function<T, T> check(Predicate<T> predicate,
      String message) {
    return value -> {
  ...
  public static <T> Function<T, T> check(Predicate<T> predicate,
      Function<T, String> messageComposer) {
    return value -> {
      if (!predicate.test(value)) {
  ...
  public static void parse(String value, Consumer<FormField> fieldSetter,
