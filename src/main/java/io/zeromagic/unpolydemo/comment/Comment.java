...
public record Comment(int id, CommentSubject subject, String author,
                      Instant timestamp, String content)
    implements Comparable<Comment> {
  private static final Comparator<Comment> COMPARATOR = Comparator.comparing(
      Comment::timestamp).thenComparing(Comment::id);
  private static final AtomicInteger ID_GENERATOR = new AtomicInteger();

  public Comment(CommentSubject subject, String author, Instant timestmap,
      String content) {
