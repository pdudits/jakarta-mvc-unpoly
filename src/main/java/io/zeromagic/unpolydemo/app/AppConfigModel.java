...
public class AppConfigModel {
    ...
    private EnumSet<RuntimeSize> availableSizes = EnumSet.noneOf(RuntimeSize.class);
    ...
    public boolean inputValid() {
        return FormField.allValid(contextRoot, jakartaVersion, javaVersion, scalabilityField,
